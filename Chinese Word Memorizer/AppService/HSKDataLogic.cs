...
{
    /// <summary>
    /// Класс содержит скрипт формирования и проверки списка
    /// </summary>
    public class HSKDataLogic
    {
        /// <summary>
        /// Запуск скрипта формирования и проверки списка, а так же его добавление в глобальную память программы
        /// </summary>
